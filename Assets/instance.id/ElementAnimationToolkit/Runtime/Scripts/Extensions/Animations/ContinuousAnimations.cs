            ...
            Vector4 borderSelection = default)
        {
            ...
            if (borderSelection != default)
            {
                ...
                if (debug)
                {
                    ...
                    table.WithHeader("border", "padding");

                    table.WithRow(borderValues.x, paddingValues.x);
                    table.WithRow(borderValues.y, paddingValues.y);
                    table.WithRow(borderValues.z, paddingValues.z);
                    table.WithRow(borderValues.w, paddingValues.w);
