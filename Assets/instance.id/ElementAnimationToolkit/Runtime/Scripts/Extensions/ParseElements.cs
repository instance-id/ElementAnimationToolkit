...
namespace instance.id.EATK.Extensions
{
    ...
    public static class StyleParser
    {
        ...
        public static VisualElement CreateVisualElement(XmlNode node)
        {
            ...
            if (node.Attributes != null)
                foreach (XmlAttribute attr in node.Attributes)
                {
                    ...
                    // Debug.Log($"Finished Parsing Attribute: {attr.Name}");
                }
            // else
            // {
            //     element = ApiProvider.CreateUnityType<VisualElement>();
            // }

            // Debug.Log("Finished Creating Element");
            ...
            foreach (XmlNode child in node.ChildNodes)
            {
                ...
                // Debug.Log($"Finished adding child: {child.Name}");
            }
        ...
        public static object ParseProperty(this PropertyInfo property, string value)
        {
        ...
        // public static StyleInt ToStyleInt(this string str) => new StyleInt(int.Parse(str.Replace("px", "")));
        ...
        public static StyleEnum<T> ToStyleEnum<T>(this string str) where T : struct, IConvertible => new StyleEnum<T>
