...
#pragma warning restore 67
...
#if UNITY_EDITOR
        // --|---------------------------------- Custom elements
        public static VisualElement CreateEnumField<T>(this T enumField, Action<T> onChange = null, string label = null, T defaultValue = default)  // @formatter:on
        {
        ...
        /// <typeparam name="T">VisualElement</typeparam>
        public static VisualElement CreateWithLabel<T>(this T element, out VisualElement variable, string name = null,
        ContainerType containerType = ContainerType.Row,
        string labelText = "",
        string labelClass = default,
        float labelMinWidth = default,
        string elementClass = default,
        string[] elementClasses = default)
            where T : VisualElement
        {
            ...
            if (elementClasses != default)
                foreach (var t in elementClasses)
                    element.AddToClassList(t);
        ...
        public static T ToUSS<T>(this T element, string name, string[] elementClassNames) where T : VisualElement
        {
            if (elementClassNames != null && element.name != null)
            {
                element.name = elementClassNames.FirstOrDefault();
        ...
        public static T SetBackgroundColor<T>(this T element, StyleColor color = default) where T : VisualElement
        {
            if (element.style.backgroundColor != color) element.style.backgroundColor = color;
            return element;
        }
